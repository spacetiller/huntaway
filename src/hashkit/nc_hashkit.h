...
#define GDIST_CODEC(ACTION)                     \
    ACTION( DIST_ALL,        	all           ) \
    ACTION( DIST_FIRST,        	first         ) \
    ACTION( DIST_LAST,          last          ) \
...
#define DEFINE_ACTION(_gdist, _name) _gdist,
typedef enum gdist_type {
    GDIST_CODEC( DEFINE_ACTION )
    DIST_NONE
} gdist_type_t;
#undef DEFINE_ACTION
