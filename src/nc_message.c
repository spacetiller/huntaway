...
/*
 * when write, copy mbuf of current msg(stub) to the other msgs, for there is only one client conn to read 
 * changed Juncheng 2014.1.24
 * remove mbuf copy, 2014.5.4
 */
static rstatus_t
...
/*
 * add code to handle rsp_send situation, only send one msg to the client.
 * changed 2014.1.24
 *
 */
static rstatus_t
